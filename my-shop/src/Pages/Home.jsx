    ...
    <div>
      ...
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 p-8">
        {products.map((product) => (
          <div
            key={product.id}
            className="p-2 md:p-5 rounded-2xl bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 hover:shadow-md hover:scale-105 transition-all"
          >
            ...
            <h3 className="text-md line-clamp-1 font-medium mb-2 text-gray-900 dark:text-white">
              {product.name}
            </h3>
            ...
            <div className="flex items-center justify-between mt-2.5 border-t border-gray-300 dark:border-gray-600 pt-2">
              <div className="flex items-center gap-x-2.5 md:gap-x-4">
                ...
                <span className="block rounded-full text-gray-400 hover:text-teal-600 dark:hover:text-emerald-500 transition-all cursor-pointer">
                  <svg className="w-4 h-4 md:w-4.5 md:h-4.5 lg:w-6 lg:h-6">
